    ...
    <>
      <div className="text-gray-500 flex flex-col h-screen  justify-center">
        <div className="w-full flex flex-col align-middle 2xl:px-20 ">
          <p className="text-sm sm:text-xl mt-5 mb-3 text-teal">
            Hi, my name is
          </p>
          ...
          <div className="flex flex-row my-5">
            <Link target={"_blank"} href={about.github}>
              <Image
                alt="github"
            ...
            <Link target={"_blank"} href={about.instagram}>
              <Image
                alt="instagram"
            ...
            <Link target={"_blank"} href={about.twitter}>
              <Image
                alt="twitter"
                className="mx-3 invert transform transition duration-100 hover:scale-110"
                height={30}
            ...
            <Link target={"_blank"} href={about.linkedIn}>
              <Image
                alt="linkedin"
                className="mx-3 invert transform transition duration-100 hover:scale-110"
                height={30}
          ...
          <div className="my-5">
            <Link
              ...
              className="py-3 px-5 mr-10 border-2 border-teal rounded w-32 text-center text-teal hover:bg-teal hover:text-gray-900"
            >
              Resume
            </Link>
            <Link
              target={"_blank"}
              href={about.mailTo}
              className="py-3 px-5  border-2 border-teal rounded w-32 text-center text-teal hover:bg-teal hover:text-gray-900 "
            >
              Contact
            </Link>
          </div>
